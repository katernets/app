...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { cminho: @produto.cminho, descricao: @produto.descricao, preco: @produto.preco, tipo: @produto.tipo } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { cminho: @produto.cminho, descricao: @produto.descricao, preco: @produto.preco, tipo: @produto.tipo } }
